...
const AdminLogin = () => {
  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ title: "Check your email", description: "Sign-in did not create a session. Check your email for a confirmation link or complete any required steps.", variant: 'default' });
    } catch (err: unknown) {
