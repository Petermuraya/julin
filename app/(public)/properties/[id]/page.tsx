  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content={`${process.env.NEXT_PUBLIC_BASE_URL ?? ''}#/properties/${property.id}`} />
        ...
        <meta property="twitter:url" content={`${process.env.NEXT_PUBLIC_BASE_URL ?? ''}#/properties/${property.id}`} />
        <meta property="twitter:title" content={property.title} />
        <meta property="twitter:description" content={seoDescription} />
        <meta property="twitter:image" content={property.image || ""} />
        <link rel="canonical" href={`${process.env.NEXT_PUBLIC_BASE_URL ?? ''}#/properties/${property.id}`} />
